        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Jak grać w Miedziowe Karty</p>
            </div>
          </div>
          ...
          <div className="bg-[#1e2a3a] border border-gray-700/50 rounded-xl p-6 text-left">
            ...
            <ul className="text-gray-300 space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span>Pełne zasady gry w 66</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-teal-500">✓</span>
                <span>Zasady gry w Tysiąca</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-teal-500">✓</span>
                <span>Wyjaśnienie licytacji i luf</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-teal-500">✓</span>
                <span>Interaktywny samouczek</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-teal-500">✓</span>
                <span>Punktacja i meldunki</span>
              </li>
            </ul>
          </div>
          <button
